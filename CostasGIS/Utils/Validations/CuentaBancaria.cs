...
namespace Utils.Validations
{
    public class CuentaBancaria
    {
        ...
        public static string ObtenerCodigoBanco(string cuentaCompleta)
        {
            return cuentaCompleta.Substring(0, 4);
        }

        public static string ObtenerCodigoOficina(string cuentaCompleta)
        {
            return cuentaCompleta.Substring(4, 4);
        }

        public static string ObtenerCodigoDC(string cuentaCompleta)
        {
            return cuentaCompleta.Substring(8, 2);
        }

        public static string ObtenerCodigoCuenta(string cuentaCompleta)
        {
            return cuentaCompleta.Substring(10, 10);
        }
